        ...
        <ns0:ValidationErrorList>
          {(
              ...
              (: BEGIN - Empty Field Validations :)
                else if(empty($rootElement/ns1:BODY/ns1:CNT_ID/text())) then
                    <ns0:ValidationError>
                        <ns0:code>1-102-00</ns0:code>
                        <ns0:message>One or more fields have an incorrect format. CNT_ID is empty</ns0:message>
                        <ns0:submessage>CNT_ID is empty</ns0:submessage>
                    </ns0:ValidationError>
